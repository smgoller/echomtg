...
require 'echomtg/version'

Gem::Specification.new do |spec|
  spec.name          = 'echomtg'
  spec.license       = 'Apache-2.0'
  spec.version       = Echomtg::VERSION
  spec.authors       = ['Sean Goller']
  spec.email         = ['sean@goller.net']

  spec.summary       = 'CLI to interact with EchoMTG.'
  spec.description   = 'CLI to interact with EchoMTG.'
  spec.homepage      = 'https://github.com/smgoller/echomtg'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/smgoller/echomtg'
    spec.metadata['changelog_uri'] = 'https://github.com/smgoller/echomtg/CHANGELOG.md'
  else
